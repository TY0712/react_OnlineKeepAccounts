...
export default class index extends Component {
    ...
    onChange1 = (value) => {
        ...
        axios.post("https://qcdfa6.fn.thelarkcloud.com/ShowYearForm", {
            "userId": this.props.match.params.userId,
            "billList": value.value,
            "payYear": Number(this.state.chooseYear)
        }).then(
            res => {
        ...
        axios.post("https://qcdfa6.fn.thelarkcloud.com/ShowYearForm2", {
            "userId": this.props.match.params.userId,
            "billList": value.value,
            "payYear": Number(this.state.chooseYear)
        }).then(
    ...
    onChange2 = (date, dateString) => {
        ...
        this.setState({ chooseYear: dateString })
        axios.post("https://qcdfa6.fn.thelarkcloud.com/ShowYearForm", {
            "userId": this.props.match.params.userId,
            "billList": this.state.billList,
            "payYear": Number(dateString)
        }).then(
            res => {
                // console.log(res.data)
                this.setState({
        ...
        return (
            <div>
                <div className="select-title">
                    ...
                    <DatePicker onChange={this.onChange2} picker="year" allowClear={false} placeholder="选择年份" />
                </div>
